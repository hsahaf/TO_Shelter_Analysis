...
```{r}
#### 2018: Average Number of Actively Homeless in Each Group ####
cleaned_shelter_data|>
...
```{r}
#### 2020: Average Number of Actively Homeless in Each Group ####
cleaned_shelter_data|>
  select(population_group, Year, Month, actively_homeless)|>
  filter(!population_group == "All Population")|>
  filter(Year == "20")|>
...
```{r}
#### 2022: Average Number of Actively Homeless in Each Group ####
cleaned_shelter_data|>
  select(population_group, Year, Month, actively_homeless)|>
  filter(!population_group == "All Population")|>
  filter(Year == "22")|>
